		...
		$data  .= '<div id="dialog-form">
							<div style="float: left; width: 500px;">
								<fieldset >
							    	...
							    	<table width="100%" class="dialog-form-table">
										...
										<tr>
											<td style="width: 180px;">
												<input type="text" id="planned_end_date" class="idle" onblur="this.className=\'idle\'" onfocus="this.className=\'activeField\'" value="' .  $res['planned_end_date']. '" />
											</td>
											<td style="width: 180px;">
											...
											<td style="width: 180px;">
												<input type="text" id="call_duration" class="idle" onblur="this.className=\'idle\'" onfocus="this.className=\'activeField\'" value="' . $res['call_duration'] . '" />
											</td>
											<td style="width: 69px;">
											</td>
										</tr>';
						...
						$data  .= '<table class="dialog-form-table">
							    		...
							    		<tr>
											...
											<td style="width: 180px;"><select id="persons_id" class="idls object">'.Getpersonss($res['persons_id']).'</select></td>
										...
										<tr>
											...
											<td colspan="6">
												<textarea  style="width: 641px; resize: none;" id="comment" class="idle" name="call_content" cols="300" rows="2">' . $res['comment'] . '</textarea>
											</td>
										</tr>
										<tr>
		...
		$data  .= '<div id="dialog-form">
				...
				$data  .= '<table width="100%" class="dialog-form-table">
								...
								<tr>
									...
									<td colspan="6">
										<textarea  style="width: 641px; resize: none;" id="content1" class="idle" name="call_content" cols="300" rows="2">' . $res['content1'] . '</textarea>
									</td>
								</tr>		
							</table>
						</fieldset >
					...
					<div style="float: right;  width: 355px;">
						<fieldset>
									...
									<table style="height: 243px;">
										<tr>
											<td style="width: 180px;">PIN კოდი</td>
											<td style="width: 180px;">მეგობრის PIN ცოდი</td>
										</tr>
										<tr>
											<td style="width: 180px;"><input type="text" id="personal_pin" class="idle" onblur="this.className=\'idle\'" onfocus="this.className=\'activeField\'" value="' . $res['personal_pin']  . '" /></td>
											<td style="width: 180px;"><input type="text" id="personal_pin" class="idle" onblur="this.className=\'idle\'" onfocus="this.className=\'activeField\'" value="' . $res['friend_pin']  . '" /></td>
