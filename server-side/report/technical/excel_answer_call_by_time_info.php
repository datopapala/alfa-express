...
$res124 = mysql_query("
	...
	$dat .= '
						<ss:Row>
							...
							<ss:Cell>
								<ss:Data ss:Type="String">'.(($row[call_answer_pr]!='')?$row[call_answer_pr]:"0").' %</ss:Data>
							</ss:Cell>
							<ss:Cell>
								<ss:Data ss:Type="String">'.(($roww[unanswer_count]!='')?$roww[unanswer_count]:"0").'</ss:Data>
							</ss:Cell>
							<ss:Cell>
								<ss:Data ss:Type="String">'.(($roww[call_unanswer_pr]!='')?$roww[call_unanswer_pr]:"0").' %</ss:Data>
							</ss:Cell>
							<ss:Cell>
								<ss:Data ss:Type="String">'.(($row[avg_durat]!='')?$row[avg_durat]:"0").' წუთი</ss:Data>
							</ss:Cell>
							<ss:Cell>
								<ss:Data ss:Type="String">'.(($row[avg_hold]!='')?$row[avg_hold]:"0").' წამი</ss:Data>
							</ss:Cell>
							<ss:Cell>
...
<ss:Workbook xmlns:ss="urn:schemas-microsoft-com:office:spreadsheet" xmlns:x="urn:schemas-microsoft-com:office:excel" xmlns:o="urn:schemas-microsoft-com:office:office">
	...
	<ss:Worksheet ss:Name="'.$name.'">
		...
		<ss:Table x:FullRows="1" x:FullColumns="1" ss:ExpandedColumnCount="9" ss:ExpandedRowCount="20">
			...
			<ss:Row ss:AutoFitHeight="1" ss:Height="25">
				<ss:Cell ss:StyleID="headercell">
					<ss:Data ss:Type="String">თარირი</ss:Data>
					<ss:NamedCell ss:Name="Print_Titles" />
				</ss:Cell>
				<ss:Cell ss:StyleID="headercell">
					<ss:Data ss:Type="String">ნაპასუხები</ss:Data>
					<ss:NamedCell ss:Name="Print_Titles" />
				</ss:Cell>
				<ss:Cell ss:StyleID="headercell">
					<ss:Data ss:Type="String">% ნაპასუხები</ss:Data>
				...
				<ss:Cell ss:StyleID="headercell">
					<ss:Data ss:Type="String">უპასუხო</ss:Data>
					<ss:NamedCell ss:Name="Print_Titles" />
				</ss:Cell>
				<ss:Cell ss:StyleID="headercell">
					<ss:Data ss:Type="String">% უპასუხო</ss:Data>
				...
				<ss:Cell ss:StyleID="headercell">
					<ss:Data ss:Type="String">საშ. ლოდინის ხანგძლივობა</ss:Data>
					<ss:NamedCell ss:Name="Print_Titles" />
				</ss:Cell>
				<ss:Cell ss:StyleID="headercell">
					<ss:Data ss:Type="String">შესვლა</ss:Data>
					<ss:NamedCell ss:Name="Print_Titles" />
				</ss:Cell>
				<ss:Cell ss:StyleID="headercell">
					<ss:Data ss:Type="String">გასვლა</ss:Data>
					<ss:NamedCell ss:Name="Print_Titles" />
				</ss:Cell>
			</ss:Row>
